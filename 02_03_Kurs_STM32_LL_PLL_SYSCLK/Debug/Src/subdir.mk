...
Src/%.o Src/%.su: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m0plus -std=gnu11 -g3 -DDEBUG -DSTM32G071RBTx -DSTM32 -DSTM32G0 -DSTM32G071xx -c -I../Inc -I"D:/STM32_Workspace_Kurs_Low_Layer/02_03_Kurs_STM32_LL_PLL_SYSCLK/Drivers/CMSIS/Device/Inc" -I"D:/STM32_Workspace_Kurs_Low_Layer/02_03_Kurs_STM32_LL_PLL_SYSCLK/Drivers/CMSIS/Inc" -I"D:/STM32_Workspace_Kurs_Low_Layer/02_03_Kurs_STM32_LL_PLL_SYSCLK/Drivers/STM32G0xx_LL_Driver/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
